...
// Muestra el spinner al principio
showLoader();
...
// Oculta el spinner y muestra el contenido cuando la página está completamente cargada
window.onload = function () {
	actualizarCantidadTotal();
	hideLoader();
	// También puedes agregar otras operaciones que desees realizar después de la carga completa.
};